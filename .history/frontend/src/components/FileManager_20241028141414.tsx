          ...
          {contextMenu.type === 'file' ? (
            <>
              ...
              >
                ...
                翻譯後加入知識庫 ({selectedFiles.length} 個檔案)
              </button>
              <button
                className="w-full px-4 py-2 text-left hover:bg-gray-100 flex items-center"
                onClick={() => {
              ...
              >
                ...
                直接加入知識庫 ({selectedFiles.length} 個檔案)
              </button>
              <button
                className="w-full px-4 py-2 text-left hover:bg-gray-100 flex items-center"
                onClick={async () => {
                  // 先翻譯並加入預設知識庫
                  await onBatchTranslateAndEmbed(selectedFiles, 'default');
                  // 然後切換到知識對話模式
                  onModeChange("chat");
                  // 開始檔案對話
              ...
              >
                ...
                翻譯後檔案對話 ({selectedFiles.length} 個檔案)
              </button>
              <button
                className="w-full px-4 py-2 text-left hover:bg-gray-100 flex items-center"
                onClick={() => {
              ...
              >
                <MessageSquare className="w-4 h-4 mr-2" />
                直接檔案對話 ({selectedFiles.length} 個檔案)
              </button>
